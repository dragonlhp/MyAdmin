...
var columns = [[
    ...
    {title: '发布方', field: 'supply_name', width: '15%', align: 'left', sortable: true},
    {title: '审核状态', field: 'check_status', width: '10%', align: 'left', sortable: true,
        formatter: function (value) { //格式化数据
            if(value ==1){
                return '待审核';
            }else if(value ==2){
    ...
    {title: '申请方', field: 'apply_name', width: '16%', align: 'left', sortable: true},
    {
    ...
    {title: '申请时间', field: 'cooperation', width: '20%', align: 'center', sortable: true},
    {
...
Option = {
    ...
    delete: function (value) {
        ...
        if (is) {
            $.messager.confirm('确认对话框', '您确定想要修改发布状态吗？', function (r) {
                if (r) {
                    Qrck.put(PostModule + '/status', {id: is.id, status: 9}, function () {
                    }, function (data) {
                        if (data.code = 200) {
                            $.messager.alert('提示', '修改成功!', 'warning', function () {
                                $(DataGrid).datagrid('load');
