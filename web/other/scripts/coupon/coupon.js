...
var data = [[
    ...
    {title: '合同金额', field: 'contract_price', width: '6%', align: 'left', sortable: true},
    {title: '服务折扣', field: 'discounts', width: '5%', align: 'left', sortable: true},
    {title: '联系人', field: 'link_name', width: '7%', align: 'left', sortable: true},
    {title: '联系方式', field: 'link_tel',width: '12%', align: 'left', sortable: true},
    {
    ...
    Pass: function (status, value) {
        ...
        if (is !== null) {
            $.messager.confirm('确认对话框', '请确定当前操作？', function (r) {
                if (r) {
                    Qrck.put(PostModule + '/status', {ids: is.id, status: status}, function () {
                    }, function (data) {
                        if (data.code = 200) {
