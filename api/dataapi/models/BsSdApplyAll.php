...
/**
 * This is the model class for table "bs_sd_apply_all".
 *
 * @property integer $id
 ...
 */
class BsSdApplyAll extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'apply_id', 'sup_id', 'sup_role', 'pro_cat', 'pro_type', 'pro_id', 'check_status', 'status'], 'integer'],
            [['pro_type', 'pro_id', 'cooperation'], 'required'],
            [['cooperation', 'created', 'updated'], 'safe'],
            [['apply_name', 'supply_name'], 'string', 'max' => 255]
        ];
    }
