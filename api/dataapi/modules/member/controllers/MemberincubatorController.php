...
class MemberincubatorController extends QrckController
{
    ...
    public function actionGet()
    {
        ...
        $model = BsMemberIncubator::find()->where("member_id = $id")->all();
    ...
    public function actionSave()
    {
        ...
        $modelone = BsMemberIncubator::find()->where("member_id = $id")->asArray()->all();
    ...
    {
        $model = BsMemberIncubator::findOne($id);
